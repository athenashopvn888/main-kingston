...
export default function DeliveryContent() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      await fetch(
        `https://script.google.com/macros/s/AKfycbySrZYxI-NNnXfxY1jXOqHgT2HQi4zst2Fgte6FXTeymat_W_r0o1E3P83EfnVCjEk0/exec?action=delivery_email&email=${encodeURIComponent(email)}&store=MKC01`,
    ...
    <main className={styles.main}>
      ...
      <div className={styles.content}>
        ...
        <p className={styles.pageSubtitle}>
          Main Kingston Cannabis is preparing delivery updates for Kingston Road
          and Main Street, East Toronto, and nearby local areas. Sign up below
          to be the first to know when delivery goes live.
        </p>
        ...
        <div className={styles.infoGrid}>
          <div className={styles.infoCard}>
            ...
            <p className={styles.infoDesc}>
              Launch updates will focus on Kingston Road and Main Street, East
              Toronto, and nearby local areas.
            </p>
          </div>
          <div className={styles.infoCard}>
            <span className={styles.infoIcon}></span>
            ...
            <p className={styles.infoDesc}>
              Built around Main Street, Kingston Road, East Toronto, Upper
              Beaches, Danforth, Victoria Park, Birch Cliff, Scarborough
              Southwest.
            </p>
          </div>
          <div className={styles.infoCard}>
