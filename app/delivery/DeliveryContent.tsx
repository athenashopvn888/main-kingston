    ...
    <main className={styles.main}>
      ...
      <div className={styles.content}>
        ...
        <p className={styles.pageSubtitle}>
          Main Kingston Cannabis is launching delivery across Toronto.
        ...
        <div className={styles.ctaSection}>
          <p className={styles.ctaText}>
            Can&apos;t wait? Visit us in-store at <strong>615 Kingston Rd, Toronto</strong> —
            open <strong>24 hours</strong>. Call <strong>(905) 467-0615</strong>.
          </p>
        </div>
      </div>
      <Footer />
