...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "editorialRemark": {
      ...
      "authorName": "Clara Main",
      "authorHandle": "@ClaraKingston",
      "authorRole": "House Writer",
      "body": "The address check is not boring; it is the part that saves the trip. Store names and old tabs can blur together, so matching Kingston Rd, the phone number, and the current page is worth the minute. If the visit has a budget, let the menu do the sorting before you are standing at the counter."
    },
  ...
  },
  {
    ...
    "editorialRemark": {
      "label": "Another House Writer Adds",
      "authorName": "Main Kingston Desk",
      "authorHandle": "@MainKingstonDesk",
  ...
  },
  {
    ...
    "oldTitle": "Main Kingston Cannabis Local Visit Guide for Adults 19+",
    "wordCount": 531,
    "businessReviewFlags": []
  }
];
