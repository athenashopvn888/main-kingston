...
export const STATIC_POSTS: StaticBlogPost[] = [
  ...
  },
  {
    ...
    "title": "How to Compare Main Kingston Cannabis Flower Without Guessing",
    "seoTitle": "Main Kingston Cannabis Flower Guide | Budget to Exotic",
    "seo_title": "Main Kingston Cannabis Flower Guide | Budget to Exotic",
    "metaDescription": "Compare Main Kingston Cannabis flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "meta_description": "Compare Main Kingston Cannabis flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "h1": "How to Compare Main Kingston Cannabis Flower Without Guessing",
    "excerpt": "A shopper-first flower guide for comparing Budget, AA, AAA+, Premium, and Exotic sections at Main Kingston Cannabis.",
    "authorName": "Clara Main",
    "authorHandle": "@ClaraKingston",
    "authorRole": "House Writer",
    "author": "Clara Main",
  ...
  },
  {
    ...
    "title": "How to Shop the Main Kingston Cannabis Menu Like a Pro",
    "seoTitle": "Main Kingston Cannabis Menu Guide | east Toronto Weed Store",
    "seo_title": "Main Kingston Cannabis Menu Guide | east Toronto Weed Store",
    "metaDescription": "Shop the Main Kingston Cannabis menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "meta_description": "Shop the Main Kingston Cannabis menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "h1": "How to Shop the Main Kingston Cannabis Menu Like a Pro",
    "excerpt": "A natural guide to shopping the Main Kingston Cannabis menu without turning the visit into a guessing game.",
    "authorName": "Miles Kingston",
    "authorHandle": "@MilesOnMain",
    "authorRole": "House Writer",
    "author": "Miles Kingston",
