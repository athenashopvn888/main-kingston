...
export const metadata: Metadata = {
  title: resolveDocumentTitle("Contact Us — Main Kingston Cannabis | 615 Kingston Rd, Toronto"),
  description:
  ...
  openGraph: {
    ...
    description:
      "615 Kingston Rd, Toronto. Open 24 hours, 7 days a week. Premium cannabis, always fire.",
  },
};
