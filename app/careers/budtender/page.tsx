...
export const metadata: Metadata = {
  title: { absolute: "Budtender Or Manager Application | Main Kingston Cannabis" },
  description:
    "Apply online for budtender or manager opportunities at Main Kingston Cannabis. Submit availability, customer-service experience, motivation, determination, and a required selfie.",
  alternates: {
    canonical: "https://www.mainkingstoncannabis.ca/careers/budtender",
  },
};
...
const applicantFaqs = [
  ...
  },
  {
    ...
    a: "Tell us your real availability, earliest start date, retail background, what motivates you, and why you want to work with Main Kingston.",
  },
  {
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <div className={styles.heroCopy}>
            <span className={styles.eyebrow}>Main Kingston Careers</span>
            <h1>Budtenders / Managers Wanted</h1>
            <p>
              Main Kingston Cannabis is collecting applications from sharp, friendly budtender and manager candidates who can help customers shop with confidence and keep the store running smooth.
            </p>
          ...
          <div className={styles.heroPanel} aria-label="Hiring role snapshot">
            ...
            <ul>
              ...
              <li>Late-shift availability is a plus at Main Kingston</li>
            </ul>
          </div>
        </div>
      </section>
