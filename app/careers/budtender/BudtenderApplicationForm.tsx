...
const requiredFields = [
  ...
  { name: "WhyQLC", label: "Why you want to work at Main Kingston" },
...
export default function BudtenderApplicationForm() {
  ...
  return (
    <form className={styles.applicationForm} onSubmit={handleSubmit} noValidate>
      <input type="hidden" name="StoreKey" value="MKC01" />
      <input type="hidden" name="StoreName" value="Main Kingston Cannabis" />
      ...
      <div className={styles.formSection}>
        ...
        <label className={styles.field}>
          <span>Why do you want to work at Main Kingston Cannabis?</span>
      ...
      <div className={styles.formSection}>
        ...
        <fieldset className={styles.choiceGroup}>
          <legend>Can you reliably get to Kingston Road for scheduled shifts?</legend>
