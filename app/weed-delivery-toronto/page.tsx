...
export const metadata: Metadata={title:resolveDocumentTitle("Kingston Road Weed Delivery | Main Kingston Cannabis"),description:"Explore Kingston Road and Upper Beaches weed delivery from Main Kingston Cannabis at 615 Kingston Rd. Contact the dispatcher to confirm current availability and delivery details.",alternates:{canonical}};
