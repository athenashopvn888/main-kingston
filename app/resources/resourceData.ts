...
export const RESOURCE_PAGES: ResourcePage[] = [
  {
    ...
    cards: [
      { title: "Weed Visit Guide", href: "/resources/kingston-road-east-toronto-weed-visit-guide", text: "Review the published local details for a Kingston Road and East Toronto visit." },
      ...
      { title: "Weed Value Guide", href: "/resources/weed-value-guide", text: "Explore Budget Weed, AA Weed and AAA+ Weed collections." },
  ...
  {
    slug: "kingston-road-east-toronto-weed-visit-guide",
    title: "Main Kingston cannabis Weed Guide for Kingston Road & East Toronto",
  ...
  },
  {
    ...
    title: "Main Kingston cannabis Weed & Flower Guide",
    seoTitle: "Main Kingston Cannabis Flower Tier Guide | Exotic, Premium, AAA+, AA And Budget",
    description: "Compare Main Kingston Cannabis flower tiers with posted per-gram prices, 3g specials, 6g deal math, Budget flower, AA flower, AAA+, Premium, and Exotic.",
  ...
  },
  {
    ...
    title: "Main Kingston cannabis Weed Value Guide",
    ...
    sections: [
      {
        ...
        body: "If the search is cheap weed, budget weed, or affordable cannabis near Main Street / Kingston Road / East Toronto, start with Budget and AA. If the trip can stretch a little, AAA+ gives shoppers another value lane with 3g and 6g deal logic."
      },
      {
  ...
  {
    slug: "pre-roll-guide",
    title: "Main Kingston Cannabis Pre-Roll And Quick Trip Guide",
    seoTitle: "Main Kingston Cannabis Pre-Roll Guide | Ready-To-Smoke Menu Tips",
    description: "A pre-roll guide for Main Kingston Cannabis, with quick-trip tips for ready-to-smoke options, flower cross-shopping, edibles, vapes, concentrates, and accessories.",
  ...
  {
    slug: "native-smokes",
    title: "Main Kingston Cannabis Native Smokes Price Guide",
    seoTitle: "Main Kingston Cannabis Native Smokes Prices | Cigarettes, Backwoods And Grabba",
    description: "Main Kingston Cannabis Native smokes resource with cigarette brands and listed prices for Canadian, Putters, Canadian Goose, Nexus, Time, Backwoods, grabba, pouches, and mixed smoke items where shown.",
    eyebrow: "Native Smokes",
    intro: "This page gives cigarette shoppers a real starting point instead of a vague category page. Use it for Native cigarettes, Canadian brands, Backwoods, grabba, nicotine pouches, and mixed smoke item price checks at Main Kingston Cannabis.",
    cards: [
  ...
  },
  {
    ...
    title: "Main Kingston Cannabis Native Cigarettes Brand Guide",
    seoTitle: "Main Kingston Cannabis Native Cigarettes Guide | Brand And Price List",
    description: "A detailed Native cigarettes brand guide for Main Kingston Cannabis, including $25 cigarette listings and smoke add-on prices where shown.",
    ...
    cards: [
      ...
      { title: "Weed Visit Guide", href: "/resources/kingston-road-east-toronto-weed-visit-guide", text: "Plan the store stop using the published local details." }
    ],
    sections: [
      {
  ...
  },
  {
    ...
    cards: [
      ...
      { title: "Weed Visit Guide", href: "/resources/kingston-road-east-toronto-weed-visit-guide", text: "Review the published local details for Kingston Road and East Toronto." },
