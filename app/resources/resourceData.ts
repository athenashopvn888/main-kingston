...
export const RESOURCE_PAGES: ResourcePage[] = [
  ...
  {
    slug: "flower-guide",
    title: "Main Kingston Cannabis Flower Tier And 6g Price Guide",
  ...
  },
  {
    ...
    cards: [
      ...
      { title: "Local Visit Guide", href: "/resources/kingston-road-east-toronto-visit-guide", text: "Plan the store stop around the local area." }
    ],
    sections: [
      {
