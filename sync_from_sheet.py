"""
Main Kingston Cannabis - Auto Sync from Google Sheets
==========================================
...
a filtered menu for Main Kingston Cannabis (ALC01).
...
def main():
    print("=" * 60)
    print(f"  Main Kingston Cannabis - Product Sync (Store: {STORE_CODE})")
    print("=" * 60)
    print()
    ...
    if do_deploy:
        ...
        if result.returncode == 0:
            print("  [OK] Live at https://mainkingstoncannabis.ca")
        else:
            print(f"  Output:\n{result.stdout[-500:]}")
    else:
